...
public protocol StarWarsTableViewDelegate: AnyObject {
...
extension StarWarsTableViewDelegate {
    func tableView(cellForRowAt: IndexPath, cell: UITableViewCell) { }
    func tableView(willDisplay cellIndexPath: IndexPath, cell: UITableViewCell) { }
    func tableView(didEndDisplaying cellIndexPath: IndexPath, cell: UITableViewCell) { }
    func tableView(didSelectRowAt index: IndexPath) { }
...
public class StarWarsTableViewDataSource<T: StarWarsTableViewCell>: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    weak var delegate: StarWarsTableViewDelegate?
    
    public init(cellHeight: CGFloat?, items: [T.CellViewModel] = [], tableView: UITableView, delegate: StarWarsTableViewDelegate, animationType: CellAnimationType = .none) {
